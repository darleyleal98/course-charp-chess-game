...
namespace ChessGameCourseDotNet.Tela
{
    class Tela
    {
        ...
        public static void ImprimirTabuleiro(TabuleiroDeXadrez tabuleiro)
        {
        ...
        public static void imprimirTabuleiro(TabuleiroDeXadrez tabuleiro, bool[,] posicoePossiveis)
        {
